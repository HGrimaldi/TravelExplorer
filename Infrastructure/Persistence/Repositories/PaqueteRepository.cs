...
namespace Infrastructure.Persistence.Repositories
{
    public class PaqueteRepository : IPaqueteRepository
    {
        ...
        public async Task<bool> ExistsAsync(Guid id) => await _context.Paquetes.AnyAsync(p => p.Id == id);
        public async Task<Paquete?> GetByIdAsync(Guid id) => await _context.Paquetes.SingleOrDefaultAsync(p => p.Id == id);
